...
PREF=-prefs=build.warn_data_percentage=75 -prefs=runtime.tools.mkspiffs.path=${ARDUINO_PACKAGES}/esp8266/tools/mkspiffs/0.2.0 -prefs=runtime.tools.mkspiffs-0.2.0.path=${ARDUINO_PACKAGES}/esp8266/tools/mkspiffs/0.2.0 -prefs=runtime.tools.xtensa-lx106-elf-gcc.path=${ARDUINO_PACKAGES}/esp8266/tools/xtensa-lx106-elf-gcc/1.20.0-26-gb404fb9-2 -prefs=runtime.tools.xtensa-lx106-elf-gcc-1.20.0-26-gb404fb9-2.path=${ARDUINO_PACKAGES}/esp8266/tools/xtensa-lx106-elf-gcc/1.20.0-26-gb404fb9-2 -prefs=runtime.tools.esptool.path=${ARDUINO_PACKAGES}/esp8266/tools/esptool/0.4.13 -prefs=runtime.tools.esptool-0.4.13.path=${ARDUINO_PACKAGES}/esp8266/tools/esptool/0.4.13;
